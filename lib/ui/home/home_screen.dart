...
import 'package:glaxit_portal/modals/user_record.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<List<UserCheckInRecord>?> getRecords() async {
    ...
    try {
      final response =
          await http.post(Uri.parse('$APP_BASE_URL/today_record.php'),
              headers: <String, String>{
                'Accept': 'application/json',
                'authorization': 'Bearer 8605c8a9bcd8914021369a887f164fad',
              },
                          ...
                          child: Container(
                            child: Row(
                              children: [
                                const Padding(
                                  padding:
                                      EdgeInsets.only(bottom: 50, left: 20),
                                  child: CircleAvatar(
